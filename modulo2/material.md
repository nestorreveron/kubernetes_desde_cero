...
14. ```root@worker:˜# kubeadm join \
--token 27eee4.6e66ff60318da929 \
k8smaster:6443 \
--discovery-token-ca-cert-hash \
sha256:6d541678b05652e1fa5d43908e75e67376e994c3483d6683f2a18673e5d2a1b0``` #Recordar que este token es un ejemplo, ustedes deben usar el que generaron en el paso 14 del Master Node
